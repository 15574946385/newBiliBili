package com.andrew.song.network.base

import com.andrew.song.BuildConfig
import com.andrew.song.bean.exception.NetworkException
import com.andrew.song.constant.ErrorCode
import com.andrew.song.network.interceptor.CommonRequestInterceptor
import com.andrew.song.network.interceptor.CommonResponseInterceptor
...
abstract class BaseNetworkApi<I>(private val baseUrl: String) : IService<I> {
    ...
    companion object {
        ...
        private val defaultOkHttpClient by lazy {
            ...
            if (com.andrew.song.BuildConfig.DEBUG) {
